...
import scss from "./Regis.module.scss";
...
const RegistrationPage = () => {
	...
	return (
		<div className={scss.container1}>
			<div className={scss.tooltipcontainer}>
				<div className={scss.tooltip}>
					<div className={scss.profile}>
						<div className={scss.user}>
							<div className={scss.img}>Ui</div>
							<div className={scss.details}>
								<div className={scss.name}>User</div>
								<div className={scss.username}>@ernest_o34</div>
							</div>
						</div>
						<div className={scss.about}>800+ Followers</div>
					</div>
				</div>
